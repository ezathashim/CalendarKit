...
public final class AllDayView: UIView {
    ...
    private let allDayEventHeight: CGFloat = 30.0
    ...
    public func reloadData() {
        ...
        for (index, anEventDescriptor) in self.events.enumerated() {
            ...
            let eventViewHeight = eventView.fittingHeightFor(maxTextLines: maxLines)
            
            eventView.heightAnchor.constraint(equalToConstant: eventViewHeight).isActive = true
